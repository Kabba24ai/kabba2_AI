...
class SendReturnDayBeforeRentalReminderJobTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        foreach ([
            'rental_return_day_before_store_message' => 'RETURN_DAY_BEFORE_STORE_MSG for {{customer_name}}',
            'rental_return_day_before_store_message_enabled' => '1',
            'rental_return_day_before_truck_message' => 'RETURN_DAY_BEFORE_TRUCK_MSG for {{customer_name}}',
