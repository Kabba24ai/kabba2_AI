    <div class="bg-white rounded-2xl shadow-sm mt-6 mb-0">
        <!-- Header with Filter -->
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-gray-200 p-4">
            <h2 class="text-base font-semibold text-gray-800">Customer Accounts
                (<span id="customer-total-count"> {{ $customers ? $customers->total() : 0 }} </span> )
            </h2>
        </div>
        ...
        <div class="max-w-full overflow-x-auto">
                    ...
                    <table id="customerTable" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm  text-left whitespace-nowrap">
                        <thead class="bg-gray-50 border-b border-gray-200 font-semibold text-gray-700">
                            <tr>
                                <th class="py-4 px-6 truncate min-w-3xs max-w-3xs font-medium text-left cursor-pointer whitespace-nowrap" onclick="sortTable(0, 'string')">Customer Name <span id="icon-0" class="ml-1"></span></th>
                                <th class="py-4 px-6 truncate min-w-3xs max-w-3xs font-medium text-left cursor-pointer whitespace-nowrap" onclick="sortTable(1, 'string')">Company Name <span id="icon-1" class="ml-1"></span></th>
                                <th class="py-4 px-6 font-medium text-left whitespace-nowrap">Phone</th>
                                <th class="py-4 px-6 font-medium text-left whitespace-nowrap">Phone - Company</th>
                                <th class="py-4 px-6 font-medium text-left cursor-pointer whitespace-nowrap" onclick="sortTable(2, 'number')">Balance <span id="icon-2" class="ml-1"></span></th>
                                <th class="py-4 px-6 font-medium text-left whitespace-nowrap">Last Payment</th>
                                <th class="py-4 px-6 font-medium text-left cursor-pointer whitespace-nowrap" onclick="sortTable(3, 'date')">Last Payment Date <span id="icon-3" class="ml-1"></span></th>
                                <th class="py-4 px-6 font-medium text-left whitespace-nowrap">Payment Due</th>
                                <th class="py-4 px-6 font-medium text-left cursor-pointer whitespace-nowrap" onclick="sortTable(4, 'days')">Days Aging <span id="icon-4" class="ml-1"></span></th>
                                <th class="py-4 px-6 font-medium w-24 whitespace-nowrap text-center">Actions</th>
                            </tr>
                        </thead>
                        ...
                        <tbody class="text-gray-700">
                            ...
                            <tr class="border-t hover:bg-gray-50" >
                                ...
                                <td class="py-4 px-6whitespace-nowrap">
            ...
            <table id="customerTable"
                class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm  text-left whitespace-nowrap">
                <thead class="border-b bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300">
                    <tr>
                        <th class="px-4 py-3 truncate min-w-3xs max-w-3xs font-medium text-left cursor-pointer whitespace-nowrap"
                            onclick="sortTable(0, 'string')">Customer Name <span id="icon-0" class="ml-1"></span>
                        </th>
                        <th class="px-4 py-3 truncate min-w-3xs max-w-3xs font-medium text-left cursor-pointer whitespace-nowrap"
                            onclick="sortTable(1, 'string')">Company Name <span id="icon-1" class="ml-1"></span>
                        </th>
                        ...
                        <th class="px-4 py-3 font-medium text-left cursor-pointer whitespace-nowrap"
                            onclick="sortTable(2, 'number')">Balance <span id="icon-2" class="ml-1"></span></th>
                        ...
                        <tr class="border-t hover:bg-gray-50">
                                    ...
                                    @if (trim($customer->company_name) !== '')
                                        <div class="flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"
                                                class="lucide lucide-building w-4 h-4 text-gray-400 mr-2">
                            ...
                            <td class="px-4 py-4 whitespace-nowrap">
                                <div class="flex items-center"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                        ...
                                        class="lucide lucide-phone w-4 h-4 text-gray-400 mr-2">
                                        <path
                            ...
                            <td class="px-4 py-4 whitespace-nowrap"
                                data-date="{{ App\Helpers\CustomHelper::formatDate(optional($customer->last_payment)->date) ?? '-' }}">
                                <div class="text-sm text-gray-700">
                                    {{ App\Helpers\CustomHelper::formatDate(optional($customer->last_payment)->date) ?? '-' }}
                                </div>
                            </td>
                            <td class="px-4 py-4 whitespace-nowrap">
                                    ...
                                    @elseif($badge === 'warning')
                                        <span
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="lucide lucide-alert-triangle w-4 h-4">
                                                <path
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="px-6 py-6 text-center text-gray-500 dark:text-gray-400">
                                ...
                                @else
                                    <span class="text-gray-400 italic">inhale… exhale… bringing your data to
                                        life…</span>
                                @endif
                            </td>
                        </tr>
