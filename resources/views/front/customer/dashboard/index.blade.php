                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full text-sm text-left text-gray-700">
                                ...
                                <tbody id="transactionTable" class="divide-y divide-gray-200">
                                    <tr data-status="charge" class=" status-row">
                                    ...
                                    <tr data-status="payment" class=" status-row">
                                    ...
                                    <tr data-status="discount" class="status-row">
                                    ...
                                    <tr data-status="refund" class=" status-row">
