<div class="flex items-center justify-between">
    ...
    <div id="categoryModal" class="fixed inset-0 z-9999 hidden">
        ...
        <div class="relative mx-auto flex min-h-screen max-w-lg items-center justify-center px-4">
            <div class="w-full overflow-hidden rounded-2xl bg-white shadow-xl" role="dialog" aria-modal="true"
                ...
                {{-- Color Picker --}}
                <div class="mt-4">
                    <label class="text-sm font-medium text-slate-700">Color <span class="text-red-500">*</span></label>

                    <input type="hidden" name="color" id="categoryColor" value="#34d399" required />
                    ...
                    <div class="mt-3 grid grid-cols-4 gap-3">
                        ...
                        @foreach ($colors as $c)
                            <button type="button" data-color-btn data-color="{{ $c }}"
                                class="relative h-12 w-full rounded-lg" style="background: {{ $c }};"
