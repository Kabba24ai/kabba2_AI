...
@push('meta')
    @if (!empty($contact_settings['contact_seo_title']))
        <meta name="title" content="{{ $contact_settings['contact_seo_title'] }}">
        <meta property="og:title" content="{{ $contact_settings['contact_seo_title'] }}">
        <meta name="twitter:title" content="{{ $contact_settings['contact_seo_title'] }}">
    @endif
    @if (!empty($contact_settings['contact_seo_description']))
         <meta name="description" content="{{ $contact_settings['contact_seo_description'] }}">
        <meta property="og:description" content="{{ $contact_settings['contact_seo_description'] }}">
        <meta name="twitter:description" content="{{ $contact_settings['contact_seo_description'] }}">
    @endif
@endpush
                                    ...
                                    @foreach ($daysOrder as $dayName)
                                        ...
                                        <div class="flex justify-start">
                                            ...
                                            @if (!$day || $day->is_closed)
                                                <span>Closed</span>
                                            @else
                                                <span>{{ formatStoreTime($day->start_time) }} -
                                                    {{ formatStoreTime($day->end_time) }}</span>
                                            @endif
                                        </div>
                                    @endforeach
