...
<div class="pt-100 p-6 section-padding">
            ...
            <tbody>
               ...
               <tr>
                  <td class="pt-2 pb-2 align-top whitespace-nowrap">
                     @if ($item->type === 'order')
                   <a href="{{ route('front.customer.dashboard.order.view', $item->orderProduct->order->unique_id) }}" class="text-brand-500 underline font-bold">{{$item->orderProduct->order->order_number}}</a>
                     @else
                     -
                     @endif
                  </td>
               ...
               {{-- @endif --}}
               <tr class="border-b border-gray-300"></tr>
               @endforeach
            </tbody>
         </table>
      </div>
      ...
      <div class="mt-3 text-center text-sm text-black-500 border-t border-gray-800">
         ...
         @endif
            ...
            <div class="mt-6 flex flex-col sm:flex-row justify-center gap-3 no-print">
                ...
                <a onclick="closeWindow()" name="action" value="close" class="inline-flex items-center px-6 py-2 rounded-md text-white bg-blue-600 text-sm font-medium shadow transition">
