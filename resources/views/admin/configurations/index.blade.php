    ...
    <polyline points="12 6 12 12 16 14"></polyline>
        ...
        <section x-data="{ open: true }"
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-md p-4 mb-5 text-left">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-blue-700 mt-1">Configure your social media presence. These links will
                                    appear on your website's footer, contact page, and can be used for social sharing
                                    functionality.</p>
                            </div>
                        </div>
                    </div>
            ...
            dark:bg-gray-800 dark:text-white";
                                ...
                                <div class="flex items-center space-x-2  overflow-visible">
                                    ...
                                    <div class="relative group overflow-visible">
                                        ...
                                        <div
                                            ...
                                            This feeds into a pop-up on the website when people deselect this option. <br>
                        ...
                        <div
                            class="space-y-1.5 {{ $setting->value_type === 'textarea' || $setting->setting_name === 'sales_tax' ? 'md:col-span-2' : '' }}">
                            ...
                            @else
                                ...
                                <div
                                    class=" @if ($setting->setting_name == 'include_extended_range') flex items-start space-x-2 @else relative @endif">
                                    ...
                                    @if ($setting->setting_name == 'sales_tax')
                                        <div class="space-y-2">
                                            ...
                                            <p class="text-sm text-gray-500 text-left">Enter percentage (e.g., 8.25 for
                                                8.25%)</p>
                                        </div>
                                    @else
                                        {!! $input !!}
                    ...
                    <div class="mt-4 rounded-md border border-amber-200 bg-amber-50 text-amber-900 text-left p-3">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-amber-700 mt-1">Both fields are critical for system security. The
                                    Master Passcode is encrypted and the Master Password is required to access/edit it.
                                    Always use strong, unique passwords and store them securely.</p>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                @if ($type == 'Payment Settings')
                    <div class="mt-4 rounded-md border border-amber-200 bg-amber-50 text-amber-900 text-left p-3">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h4 class="text-sm font-medium text-amber-800">Security Notice</h4>
                                <p class="text-sm text-amber-700 mt-1">Payment integration settings contain sensitive API
                                    keys and credentials. Master Passcode verification is required to view or modify these
                                    settings for security purposes.</p>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                @if ($type == 'Contact Us Settings')
                    <div class="bg-blue-50 border border-blue-200 rounded-md p-4 mt-5">
                        <p class="text-sm text-blue-800"><strong>Note:</strong> Store locations/addresses that appear on
                            the Contact Us page are managed in Store Settings.<a href="{{ route('admin.stores.index') }}"
                                class="text-blue-600 hover:text-blue-800 underline ml-1">Go to Store Settings page</a></p>
                    </div>
                @endif
