<style>
    #privacy_policy_description_ifr,
    #privacy_policy_description+.tox.tox-tinymce {
        height: 500px !important;
        min-height: 500px !important;
    }
 
 
    #terms_conditions_description_ifr,
    #terms_conditions_description+.tox.tox-tinymce {
        height: 500px !important;
        min-height: 500px !important;
    }
</style>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
    ...
    <div class="space-y-6">
        ...
        <div class="space-y-1.5">
            ...
            )->class('tinymce w-full min-h-[500px] rounded border border-gray-300 px-4 py-2 text-sm
            focus:ring-2 focus:ring-blue-500 focus:border-blue-500')
