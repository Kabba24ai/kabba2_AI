...
// Reason lists per contact type live in the shared _call_reason_lists
// partial (also used by the unified New Task modal) — edit them there.
const CALL_REASON_LISTS = window.CALL_REASON_LISTS;
