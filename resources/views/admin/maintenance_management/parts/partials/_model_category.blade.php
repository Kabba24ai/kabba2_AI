                ...
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        <input type="text" id="newCategoryInput"
                            class="flex-1 px-3 py-3 text-sm border rounded-md focus:ring-green-500 focus:border-green-500"
                            placeholder="Enter category name">
                        <button id="addCategoryBtn"
                            class="px-3 py-3 bg-green-600 text-md text-white rounded-lg disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center text-sm">
