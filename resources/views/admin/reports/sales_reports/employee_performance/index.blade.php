...
@section('content')
    ...
    <div id="kpi-section">
        @if (!empty($data['employees']))
            @include('admin.reports.sales_reports.employee_performance._kpi_cards', ['data' => $data])
        @endif
    </div>
...
(function () {
    ...
    function buildKpiCards(employees, storeMode) {
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-7 gap-3 mb-6">
            ...
            ${kpiCard('Orders Closed',          oc,       'text-green-600',  'bg-green-50 dark:bg-green-900/20', 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806...')}
            ...
            ${kpiCard('Paid Revenue',           pr,       'text-emerald-600','bg-emerald-50 dark:bg-emerald-900/20','M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944...')}
