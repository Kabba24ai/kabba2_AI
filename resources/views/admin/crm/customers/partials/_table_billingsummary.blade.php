                        ...
                        <tbody class="text-gray-700">
                            ...
                            <tr class="border-t hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-900"> {{ $customer->company_name ?? 'N/A' }} </div></div>
                                </td>
                                ...
                                <td class="px-4 py-4 whitespace-nowrap"><div class="text-sm text-gray-700"> {{ \App\Helpers\CustomHelper::formatCurrency(optional($customer->last_payment)->amount) }} </div></td>
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-center">
                                    <a href="{{ route('admin.crm.billingsummary.view' , $customer->unique_id) }}" class="text-blue-600  space-x-1">
