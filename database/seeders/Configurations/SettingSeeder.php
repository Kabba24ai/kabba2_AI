    ...
    private function addDefaultSalesFunnelSettings()
    {
        ...
        $this->settings['Default Sales Funnel Settings'] = [
            ...
            [
                ...
                'default_value' => "Reminder: Your rental is scheduled for driver pick-up tomorrow by {{return_time}}. Please have it clean, accessible, with the key included, and ready for return. Need more time? Rentals can’t auto-renew, but we’ll do everything we can to extend it for you if the schedule allows—just call or text (615) 815-6734 and we’ll do our best to make it happen.",
                'sort_order' => $sortOrder++,
            ],
            [
                'value_type' => 'text',
            ...
            [
                ...
                'default_value' => "Good morning! This is a reminder that your rental is due back to our store today by {{return_time}}. Please return it clean, full of fuel, and with the key included. Need an extension? Call or text us immediately this morning so we can do our best to make it happen before the day gets booked. (615) 815-6734",
                'sort_order' => $sortOrder++,
            ],
            [
                'value_type' => 'checkbox',
