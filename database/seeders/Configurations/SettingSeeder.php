...
class SettingSeeder extends Seeder
{
    ...
    private function addDefaultSalesFunnelSettings()
    {
        ...
        $this->settings['Default Sales Funnel Settings'] = [
            ...
            [
                'value_type' => 'text',
                'setting_name' => 'truck_delivery_card_order_message',
                'setting_title' => 'Truck Delivery Card Order Message',
                'default_value' => "Your Card order has been placed but Card Orders are not reserved / locked in until paid. To lock in your reservation, call (615) 815-6734 to make payment. Always call the day of your Card reservation to confirm inventory availability before arriving",
                'sort_order' => $sortOrder++,
            ],
            [
                'value_type' => 'checkbox',
                'setting_name' => 'truck_delivery_card_message_enabled',
                'setting_title' => 'Enable Truck Delivery Card Message',
                'default_value' => true,
                'sort_order' => $sortOrder++,
            ],
            [
                'value_type' => 'text',
                'setting_name' => 'store_delivery_card_order_message',
                'setting_title' => 'Store Delivery Card Order Message',
                'default_value' => "Your Card order has been placed but Card Orders are not reserved / locked in until paid. To lock in your reservation, call (615) 815-6734 to make payment. Always call the day of your Card reservation to confirm inventory availability before arriving",
                'sort_order' => $sortOrder++,
            ],
            [
                'value_type' => 'checkbox',
                'setting_name' => 'store_delivery_card_message_enabled',
                'setting_title' => 'Enable Store Delivery Card Message',
                'default_value' => true,
                'sort_order' => $sortOrder++,
            ],
            [
