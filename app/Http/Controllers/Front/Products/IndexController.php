...
class IndexController extends Controller
{
    ...
    {
        $productDetail = Product::published()->with('categories', 'options.items.groups', 'options.groups.media', 'options.groups.items', 'relatedProducts', 'mediaChildren.media')->where('slug', $slug)->firstOrFail();
