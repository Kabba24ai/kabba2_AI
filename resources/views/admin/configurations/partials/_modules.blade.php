<div class="rounded-xl dark:border-gray-800" x-data="{
    ...
    <div class="border-b border-gray-200 dark:border-gray-800">
        <nav
            ...
            <button
                class="inline-flex items-center border-b-2 px-2.5 py-2 text-sm font-medium transition-colors duration-200 ease-in-out"
                x-bind:class="activeTab === 'timezone-settings' ?
                    ' text-brand-500 border-brand-500 dark:border-brand-400 dark:text-brand-400' :
                    'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'"
                x-on:click="activeTab = 'timezone-settings'"
                id="tab-timezone-settings">
                Time Zone
            </button>
    ...
    <div class="dark:border-gray-800 my-2">
        ...
        <div x-show="activeTab === 'timezone-settings'">
            <x-admin.configurations.config-form
                id="config-timezone-form"
                :action="route('admin.configurations.save-timezone-settings')"
                saveLabel="Save">

                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    @include('admin.configurations.partials._timezone_settings')
                </div>
