    ...
    <div>
        ...
        <div class="bg-white rounded-md p-6 shadow-sm border border-gray-100 mb-6">
            <div class="flex items-center space-x-3 ">
                ...
                <h1 class="text-2xl font-semibold text-gray-900">Edit Template</h1>
            </div>
            <p class="text-gray-600 ml-14">Edit the reusable parts list template for equipment maintenance</p>
        </div>

        {{-- Form --}}
        <form action="{{ route('admin.maintenance-management.parts.parts-list.update', $list->unique_id) }}" method="POST">
            @csrf
            @method('PUT')
