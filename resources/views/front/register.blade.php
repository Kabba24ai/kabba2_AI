            ...
            <main class="flex justify-center py-16 px-4">
                <div class="bg-white shadow rounded-lg w-full max-w-md p-8">
                  ...
                  <form class="space-y-4">
                    <div>
                      <input type="text" placeholder="Name" class="w-full px-4 py-2 border rounded" required>
                    ...
                    <div>
                      <input type="password" placeholder="Password Confirmation" class="w-full px-4 py-2 border rounded" required>
                    </div>
            
                    <p class="text-xs text-gray-500">
                      Your personal data will be used to support your experience throughout this website, to manage access to your account, and for other purposes described in our <a href="#" class="underline">privacy policy</a>.
                    </p>
                  ...
                  <p class="text-center text-sm mt-6">Already have an account? <a href="{{ route('front.login') }}" class="text-blue-600">Login</a></p>
                </div>
            </main>
