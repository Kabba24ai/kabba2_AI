                    ...
                    <table id="customerTable" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm  text-left whitespace-nowrap">
                        ...
                        <tbody class="text-gray-700">
                            ...
                            <tr class="border-t hover:bg-gray-50" >
                                ...
                                <td class="py-4 px-6 whitespace-nowrap"><div class="text-sm font-semibold text-gray-900">{{ \App\Helpers\CustomHelper::formatCurrency($customer->available_credit_balance) }}</div></td>
                                <td class="py-4 px-6 whitespace-nowrap"><div class="text-sm text-gray-700"> 
                                ...
                                <td class="py-4 px-6 whitespace-nowrap" data-date="{{ App\Helpers\CustomHelper::formatDate(optional($customer->last_payment)->date) ?? '-' }}"><div class="text-sm text-gray-700">        {{ App\Helpers\CustomHelper::formatDate(optional($customer->last_payment)->date) ?? '-' }}</div></td>
                                <td class="py-4 px-6 whitespace-nowrap"><div class="text-sm font-semibold text-red-600">        - </div></td>
