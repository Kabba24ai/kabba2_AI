    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div>
            ...
            {!! html()->input(
                    'text',
                    'mail_mailer',
                    old('mail_mailer', $settings['Mail Send Settings']['mail_mailer']['setting_value'] ?? ''),
                )->class([
        ...
        <div>
            ...
            {!! html()->input('text', 'mail_host', old('mail_host', $settings['Mail Send Settings']['mail_host']['setting_value'] ?? ''))->class([
                    'w-full pl-3 py-2 text-sm border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:bg-gray-50 disabled:text-gray-500',
        ...
        <div>
            ...
            {!! html()->input(
                    'number',
                    'mail_port',
                    old('mail_port', $settings['Mail Send Settings']['mail_port']['setting_value'] ?? ''),
                )->class([
                    'w-full pl-3 py-2 text-sm border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:bg-gray-50 disabled:text-gray-500',
        ...
        <div>
            ...
            <div class="relative">
                {!! html()->input(
                        'password',
                        'mail_username',
                        old('mail_username', $settings['Mail Send Settings']['mail_username']['setting_value'] ? '************' : ''),
                    )->class([
                ...
                <button type="button"
                    ...
                    data-open-verify data-field-id="mail_username" aria-haspopup="dialog" aria-controls="verify-modal"
        ...
        <div>
            ...
            <div class="relative">
                {!! html()->input(
                        'password',
                        'mail_password',
                        old('mail_password', $settings['Mail Send Settings']['mail_password']['setting_value'] ? '************' : ''),
                    )->class([
                        'w-full pr-12 pl-3 py-2 text-sm border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:bg-gray-50 disabled:text-gray-500',
                ...
                <button type="button"
                    class="absolute inset-y-0 right-0 w-9 grid place-items-center text-blue-600/80 hover:text-blue-700"
                    data-open-verify data-field-id="mail_password" aria-haspopup="dialog" aria-controls="verify-modal"
                    aria-label="Verify to edit">
                    <x-heroicon-o-lock-closed class="w-4 h-4" />
                </button>
            </div>
        ...
        <div>
            ...
            {!! html()->input(
                    'text',
                    'mail_encryption',
                    old('mail_encryption', $settings['Mail Send Settings']['mail_encryption']['setting_value'] ?? ''),
                )->class([
                    'w-full pl-3 py-2 text-sm border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:bg-gray-50 disabled:text-gray-500',
        ...
        <div>
            ...
            {!! html()->input(
                    'text',
                    'mail_from_address',
                    old('mail_from_address', $settings['Mail Send Settings']['mail_from_address']['setting_value'] ?? ''),
                )->class([
                    'w-full pl-3 py-2 text-sm border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:bg-gray-50 disabled:text-gray-500',
        ...
        <div>
            ...
            {!! html()->input(
                    'text',
                    'mail_from_name',
                    old('mail_from_name', $settings['Mail Send Settings']['mail_from_name']['setting_value'] ?? ''),
                )->class([
                    'w-full pl-3 py-2 text-sm border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:bg-gray-50 disabled:text-gray-500',
