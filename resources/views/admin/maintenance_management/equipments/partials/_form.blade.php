                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($categories as $category)
                            <option value="{{ $category }}" {{ old('category', $equipment->category ?? '') === $category ? 'selected' : '' }}>{{ $category }}</option>
                        @endforeach
                    </select>
                    @error('category')
                        <p class="mt-1 text-xs text-red-600 flex items-center space-x-1">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            <div>
                ...
                >
                    ...
                    {{-- These will be populated from a service lists table in the future --}}
                </select>
                <p class="mt-2 text-xs text-gray-500">
