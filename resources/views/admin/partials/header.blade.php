<header x-data="{ menuToggle: false }"
    class="no-print sticky top-0 z-99 flex w-full border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 lg:border-b">
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        <div :class="menuToggle ? 'flex' : 'hidden'"
            ...
            <a href="{{ route('admin.release-notes.index') }}"
               title="What's New"
               class="relative flex items-center justify-center w-10 h-10 rounded-full text-gray-500 hover:bg-gray-100 dark:hover:bg-white/10 dark:text-gray-400 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M9 12h6m-6 4h6M7 4h10a2 2 0 012 2v13a2 2 0 01-2 2H7a2 2 0 01-2-2V6a2 2 0 012-2z"/>
                </svg>
            </a>
            <!-- Release Notes Icon -->
