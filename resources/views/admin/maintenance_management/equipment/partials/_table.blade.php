                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-3 py-3 whitespace-nowrap text-center">
                            ...
                            @elseif($serviceStatus === 'overdue')
                                <div class="inline-flex items-center justify-center w-10 h-10 bg-red-100 border-2 border-red-300 rounded-lg" title="Overdue Service">
                            ...
                            @elseif($serviceStatus === 'pending')
                                <div class="inline-flex items-center justify-center w-10 h-10 bg-yellow-100 border-2 border-yellow-300 rounded-lg" title="Pending Service">
                            ...
                            @elseif($serviceStatus === 'completed')
                                <div class="inline-flex items-center justify-center w-10 h-10 bg-green-100 border-2 border-green-300 rounded-lg" title="Service Completed">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-green-600">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                </div>
                            @else
                                <div class="inline-flex items-center justify-center w-10 h-10 bg-gray-100 border-2 border-gray-300 rounded-lg" title="Not Due">
