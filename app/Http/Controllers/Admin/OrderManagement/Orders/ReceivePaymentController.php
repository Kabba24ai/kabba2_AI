        ...
        try {
            ...
            if ($paymentMethod == "CreditCard") {
                ...
                $orderPaymentMethod = match ($paymentMethod) {
                    ...
                    // GiftCard is absent by design — it is intercepted
                    // above and settled through the gift card ledger. A
                    // bare payment row here would look like cash to
                    // reporting and would draw down no card.
