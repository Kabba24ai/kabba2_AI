                            ...
                            <div class="bg-white rounded-lg shadow border p-4">
                                <div class="flex justify-between items-start">
                                    ...
                                    <div class="flex gap-2">
                                        <a href="{{ route('admin.roles.view.user',$user->unique_id ) }}"><x-heroicon-o-eye class="w-4 h-4 text-grey-600" /></a>
                                        <a href="{{ route('admin.roles.edit.user',$user->unique_id ) }}" target="_blank">
                                    ...
                                    <!-- Delete Button -->
                                        ...
                                        <button 
                                            ...
                                            data-url="{{ route('admin.roles.delete.user', $user->unique_id) }}"
                                            type="button"
                                            title="Delete"
                                        >
