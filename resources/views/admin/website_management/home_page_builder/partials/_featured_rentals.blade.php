        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-sm mt-1 text-blue-700">
                    Which categories appear in the Featured Rentals grid is controlled by each top-level
                    category's "Feature?" toggle on the Product Categories page.
                </p>
