            ...
            @foreach ($Products as $Product)
                ...
                <div class="py-[20px] lg:py-[30px] rounded-lg text-center">
                    <a href="{{ route('front.product.details',$Product->slug) }}"
                        ...
                        <div>
                            <h3 class="mt-4 font-bold text-[18px] text-[#000] md:text-[22px] p-2 bg-[#f2f3f5] mb-4">{{$Product->product_name}}</h3>
    ...
    <section class="pb-[60px]">
        <div class="container mx-auto md:max-w-[720px] lg:max-w-[1140px] 2xl:max-w-[1320px] px-[30px] md:px-[.7rem] relative overflow-hidden">
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-y-10 lg-gap-10 2xl:gap-y-12 md:gap-8 ">
            <div>
                <iframe class="w-full h-full md:w-full md:h-[200px] lg:w-full lg:h-[320px] 2xl:w-[610px] 2xl:h-[350px]" src="https://www.youtube.com/embed/gKdAVVo9NvY?si=g57-VsreHP3dFbAx"
