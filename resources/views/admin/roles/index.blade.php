...
@section('content')
    ...
    <div class="bg-white px-4 py-4">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap justify-right items-center gap-2">
                <a href="{{route('admin.roles.manage.role')}}" class="bg-gray-700 text-white px-4 py-2 rounded flex items-center gap-2 text-sm font-medium">
    ...
    <div class="container  mt-6" id="user-wrapper">
        ...
        @include('admin.roles.partials._user_cards')
