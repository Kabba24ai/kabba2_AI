    <div id="categoriessub" class="tab-content hidden" data-tab-group="inner">
        <div class=" p-4 space-y-6">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                <div>
                    <h2 class="text-xl font-semibold text-gray-800">Customer Question Categories
                    </h2>
                    <p class="text-sm text-gray-500">Organize customer questions into logical categories
                    </p>
                </div>
                <a href="javascript:void(0)" onclick="openCategoriesModal()"
                    class="inline-flex items-center justify-center rounded-lg bg-green-600 hover:bg-green-700 px-4 py-2 text-sm font-medium text-white shadow hover:bg-brand-600 focus:outline-none focus:ring-2 focus:ring-brand-400 dark:focus:ring-brand-500 mt-3">
                    + New Category
                </a>
            </div>
            <!-- Grid -->
                    ...
                    <div class="flex justify-between items-start">
                        ...
                        <div class="flex gap-3 text-gray-500">
                            ...
                            <button class="text-green-600 hover:text-green-800 edit-category-btn"
                                ...
                                data-route="{{ route('admin.checklist-management.customer-admin.categories.update', $category->unique_id ) }}">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10"></path>
                            ...
                            <!-- Delete -->
                            <form action="{{ route('admin.checklist-management.customer-admin.categories.delete', $category->unique_id) }}"
                                method="POST"
                                class="flex delete-category-form"
        ...
        <div class="modal-scrollable w-full mx-auto">
            <div
                ...
                {{ html()->form()->attributes([
                    ...
                    'action' => route('admin.checklist-management.customer-admin.categories.store'),
                ])->open() }}
                ...
                <div class="px-6 grid grid-cols-1 gap-6 bg-gray-50">
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Customer Admin Category Name *</label>
            ...
            'class' => 'mt-1 h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500'
                        ...
                        <label for="create_rental_folder" class="text-sm text-gray-700 mt-0.5">
                            Create an Identical Category Folder in Rental Ready Admin
                        </label>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            window.openCategoryModal = function() {
                form.setAttribute("action", "{{ route('admin.checklist-management.customer-admin.categories.store') }}");
