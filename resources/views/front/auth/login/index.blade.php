                    ...
                    <main class="flex items-center justify-center py-16 px-4">
                        <div class="bg-white w-full max-w-md p-8 shadow rounded">
                            ...
                            <form class="space-y-4" action="profile-overview.html">
                                ...
                                <div>
                                    <label class="block text-xs mb-1">Password<span
                                            class="text-yellow-500">&#9432;</span></label>
                                    <input type="password" placeholder="Password"
                                        class="w-full px-4 py-2 border-b-2 border-yellow-400 focus:outline-none">
                                </div>
                                ...
                                <?php /*?> ?><button type="submit"
                                    class="w-full bg-yellow-400 hover:bg-yellow-500 py-2 rounded font-semibold flex items-center justify-center space-x-2">
                                ...
                                <p class="text-center text-sm mt-4">Don't have an account? <a
                                        href="{{ route('front.auth.register.index') }}" class="text-blue-600">Sign up</a>
                                </p>
                            </form>
                        </div>
                    </main>
