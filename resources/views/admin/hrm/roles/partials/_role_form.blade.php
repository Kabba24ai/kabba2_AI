        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="col-span-1">
                <label class="text-xs text-gray-500 font-medium">Role Name *</label>
                      ...
                      {!! html()
                        ->text('role_name', old('role_name', $role->name ?? ''))
                        ->id('role_name')
            ...
            <div class="col-span-1">
                ...
                <!-- Color Preview -->
                 ...
                 <div id="colorPreview" class="w-8 h-8 rounded-md border border-gray-300"
                 style="background-color: {{ old('color', $role->color ?? '#3b82f6') }}"></div>

                      {!! html()
                    ->select(
                        'color',
                        $colors->pluck('title', 'hash_code')->toArray(), 
                        old('color', $role->color ?? '#3b82f6')
                    )
                    ->id('colorSelect')
            ...
            <div class="col-span-1 sm:col-span-2">
                ...
                <!-- <textarea rows="3" placeholder="Describe the role's responsibilities and scope..."
                        class="w-full pl-2 pr-2 py-2 w-full border rounded-md text-sm border-gray-3003 py-2"></textarea> -->
                          ...
                          {!! html()
                    ->textarea('description', old('description', $role->description ?? ''))
                    ->id('description')
                    ->rows(3)
                    ->class('w-full pl-2 pr-2 py-2 w-full border rounded-md text-sm border-gray-300')
                    ->attributes([
