...
$watch('darkMode', value => {
    ...
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
            {{-- Left Form --}}
            <div class="relative items-center hidden w-full h-full bg-theme-50 dark:bg-white/5 lg:grid lg:w-1/2">
                <div class="flex items-center justify-center z-1">
                    ...
                    <div class="flex flex-col items-center max-w-xs">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            <span class="text-theme-500 dark:text-white/90 font-semibold">Welcome to
            ...
            <div class="fixed z-50 bottom-6 right-6">
                <button
                    class="inline-flex items-center justify-center text-white transition-colors rounded-full size-14 bg-theme-500 hover:bg-theme-600"
