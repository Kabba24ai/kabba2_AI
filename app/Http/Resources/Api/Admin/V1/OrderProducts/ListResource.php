...
class ListResource extends JsonResource
{
    ...
    public function toArray(Request $request)
    {
        $return = [
            ...
            'delivery_clean_option' => $this->delivery_clean_option ?? '',
            'delivery_clean_id' => $this->delivery_clean_id ?? 0,
            'return_clean_option' => $this->return_clean_option ?? '',
            'return_clean_id' => $this->return_clean_id ?? 0,
            'total_clean_charge' => (float) ($this->total_clean_charge ?? 0),
