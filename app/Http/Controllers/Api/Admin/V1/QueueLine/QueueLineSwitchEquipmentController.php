        ...
        return $this->ok(
            [
                ...
                'previous_equipment' => $result['previous'] ? [
                    ...
                    'power_source_type' => $result['previous']->power_source_type,
                    'key_starting_mechanism' => $result['previous']->key_starting_mechanism,
                    'is_fuel' => $result['previous']->hasFuelData(),
                    'is_key' => $result['previous']->hasKeyData(),
                ] : null,
                'current_equipment' => [
                    'unique_id' => $result['replacement']->unique_id,
                    'display_id' => $result['replacement']->equipment_id,
                    'name' => $result['replacement']->equipment_name,
                    'power_source_type' => $result['replacement']->power_source_type,
                    'key_starting_mechanism' => $result['replacement']->key_starting_mechanism,
                    'is_fuel' => $result['replacement']->hasFuelData(),
                    'is_key' => $result['replacement']->hasKeyData(),
                ],
