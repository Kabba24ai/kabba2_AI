            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-50 mb-0">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Manage your Customers Tags </p>
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function renderTags(filter = '') {
            ...
            filteredTags.forEach((tag) => {
                ...
                infoSpan.innerHTML = `<span class="text-sm text-gray-500"></span>`;
                ...
                editBtn.addEventListener('click', () => {
                    ...
                    editBtn.addEventListener('click', () => {
                        ...
                        let updateUrl = `{{ route('admin.crm.tags.update', ['tag' => ':id']) }}`;
                ...
                deleteBtn.addEventListener('click', () => {
                    window.showConfirm(
                        ...
                        if (result.isConfirmed) {
                            ...
                            let deleteUrl = `{{ route('admin.crm.tags.delete', ['tag' => ':id']) }}`;
