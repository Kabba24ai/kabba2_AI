    ...
    public function __invoke(Request $request)
    {
        ...
        foreach ($rows as $uniqueId => $row) {
            ...
            $rowData = array_merge([
                ...
                'power_source_type' => $equipment->power_source_type?->value ?? $equipment->power_source_type,
                'diesel_tank_capacity' => $equipment->diesel_tank_capacity,
                'gas_tank_capacity' => $equipment->gas_tank_capacity,
                'has_def' => $equipment->has_def,
                'def_tank_capacity' => $equipment->def_tank_capacity,
            ...
            $validator = Validator::make($rowData, [
                ...
                'power_source_type' => ['nullable', Rule::in(['diesel', 'gas', 'batteries', 'electric'])],
                'diesel_tank_capacity' => ['nullable', 'numeric', 'min:0'],
                'gas_tank_capacity' => ['nullable', 'numeric', 'min:0'],
                'has_def' => ['nullable', Rule::in(['Yes', 'No'])],
        ...
        DB::transaction(function () use ($validatedRows, $equipments, $userId) {
            foreach ($validatedRows as $uniqueId => $data) {
                ...
                $equipment->update([
                    ...
                    'power_source_type' => $data['power_source_type'],
                    'diesel_tank_capacity' => $data['diesel_tank_capacity'],
                    'gas_tank_capacity' => $data['gas_tank_capacity'],
                    'has_def' => $data['has_def'],
                    'def_tank_capacity' => $data['def_tank_capacity'],
