                ...
                <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm question-card mb-4" >
                    ...
                    <div class="flex items-center justify-between gap-3 flex-nowrap">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">Automated reminders for upcoming bookings. </p>
                        </div>
                  ...
                  <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm question-card mb-4" >
                    ...
                    <div class="flex items-center justify-between gap-3 flex-nowrap">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">Seasonal and limited-time deals </p>
                        </div>
                        <div class="flex items-center gap-4 mt-3 md:mt-0 text-gray-600 text-sm" data-count="2">
                  ...
                  <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm question-card mb-4" >
                    ...
                    <div class="flex items-center justify-between gap-3 flex-nowrap">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">Service status & help responses </p>
                        </div>
                        <div class="flex items-center gap-4 mt-3 md:mt-0 text-gray-600 text-sm" data-count="2">
