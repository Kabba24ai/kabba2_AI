...
<div class="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100 mb-6">
  <form method="GET"
        action="{{ route('admin.maintenance-management.equipment.index') }}"
        class="flex flex-wrap items-center gap-3">

    {{-- Search --}}
    <div class="relative flex-1 min-w-[180px]">
      <svg class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <select name="category"
        class="choices-select flex-1 min-w-[140px] px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white">
