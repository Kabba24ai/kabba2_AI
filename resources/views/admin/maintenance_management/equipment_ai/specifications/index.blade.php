...
<div class="space-y-6" x-data="{
    ...
    openKeyCriteriaModal(specId, checkbox, flags = {}) {
        ...
        this.keyCriteriaForm = {
            ...
            caution_if_change_value: !!(flags.caution_if_change_value ?? true),
                                            ...
                                            <div class="sm:col-span-3 lg:col-span-2 rounded-md border border-gray-200 bg-white px-3 py-2 dark:border-gray-700 dark:bg-gray-800/40">
                                                ...
                                                <div class="mt-2 grid gap-1">
                                                    <label class="inline-flex items-center gap-1.5 text-[11px] text-gray-600 dark:text-gray-300">
                                                        <input type="checkbox" name="upgrade_exceeds_value" value="1" {{ $criteriaFlags['upgrade_exceeds_value'] ? 'checked' : '' }} class="h-3.5 w-3.5 rounded border-gray-300 text-brand-500 focus:ring-brand-500">
                                                        <span>upgrade_exceeds_value</span>
                                                    </label>
                                                    <label class="inline-flex items-center gap-1.5 text-[11px] text-gray-600 dark:text-gray-300">
                                                        <input type="checkbox" name="caution_if_change_value" value="1" {{ $criteriaFlags['caution_if_change_value'] ? 'checked' : '' }} class="h-3.5 w-3.5 rounded border-gray-300 text-brand-500 focus:ring-brand-500">
                                                        <span>caution_if_change_value</span>
                                                    </label>
                                                    <label class="inline-flex items-center gap-1.5 text-[11px] text-gray-600 dark:text-gray-300">
                                                        <input type="checkbox" name="upgrade_is_below_value" value="1" {{ $criteriaFlags['upgrade_is_below_value'] ? 'checked' : '' }} class="h-3.5 w-3.5 rounded border-gray-300 text-brand-500 focus:ring-brand-500">
                                                        <span>upgrade_is_below_value</span>
                                                    </label>
                                                    <label class="inline-flex items-center gap-1.5 text-[11px] text-gray-600 dark:text-gray-300">
                                                        <input type="checkbox" name="caution_if_below_value" value="1" {{ $criteriaFlags['caution_if_below_value'] ? 'checked' : '' }} class="h-3.5 w-3.5 rounded border-gray-300 text-brand-500 focus:ring-brand-500">
    ...
    <div x-show="showKeyCriteriaModal" x-cloak class="fixed inset-0 z-9999 flex items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-lg rounded-xl bg-white shadow-2xl dark:bg-gray-900">
            <div class="border-b border-gray-100 px-5 py-4 dark:border-gray-700">
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Choose how this specification should be treated in upgrade and caution logic.</p>
            </div>

            <div class="space-y-3 px-5 py-4">
                <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                    <input type="checkbox" x-model="keyCriteriaForm.upgrade_exceeds_value" class="h-4 w-4 rounded border-gray-300 text-amber-500 focus:ring-amber-400">
                    <span>upgrade_exceeds_value</span>
                </label>
                <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                    <input type="checkbox" x-model="keyCriteriaForm.caution_if_change_value" class="h-4 w-4 rounded border-gray-300 text-amber-500 focus:ring-amber-400">
                    <span>caution_if_change_value</span>
                </label>
                <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                    <input type="checkbox" x-model="keyCriteriaForm.upgrade_is_below_value" class="h-4 w-4 rounded border-gray-300 text-amber-500 focus:ring-amber-400">
                    <span>upgrade_is_below_value</span>
                </label>
                <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                    <input type="checkbox" x-model="keyCriteriaForm.caution_if_below_value" class="h-4 w-4 rounded border-gray-300 text-amber-500 focus:ring-amber-400">
                    <span>caution_if_below_value</span>
                </label>
            </div>
