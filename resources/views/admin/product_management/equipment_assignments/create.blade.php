...
@section('title', 'Create Equipment Assignment')

@section('content')

    {{-- Header --}}
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        <h3 class="text-xl font-semibold text-gray-800 dark:text-white/90">Create Equipment Assignment</h3>
    ...
    <form action="{{ route('admin.product-management.equipment-assignments.store') }}" method="POST">
        @csrf
