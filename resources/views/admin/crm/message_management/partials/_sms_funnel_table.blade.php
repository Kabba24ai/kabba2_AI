...
<table class="min-w-full divide-y divide-gray-200 text-sm">
     ...
     @forelse($smsfunnels as $funnel)
            <tr class="hover:bg-gray-50 transition">
                <td class="py-4 px-6 whitespace-nowrap text-gray-900">{{ $funnel->category->name ?? 'No Category' }}</td>
                ...
                <td class="py-4 px-6 whitespace-nowrap">
                    <div class="text-sm font-medium text-gray-900">{{ App\Helpers\CustomHelper::formatDate($funnel->created_at) ?? 'N/A' }}</div>
                    <div class="text-sm text-gray-500 mt-1">{{ App\Helpers\CustomHelper::formatTime($funnel->created_at) ?? 'N/A' }}</div>
                </td>
                ...
                <td class="py-4 px-6 whitespace-nowrap">
                    <div class="flex items-center space-x-3">
                        ...
                        <button type="button" class="edit-sms-funnel-btn text-grey-600 flex items-center text-xs" title="Credits" data-id="{{ $funnel->id }}">
                        ...
                        <!-- COPY (Green Button) -->
                        <a href="{{ route('admin.crm.message-management.sms-funnel.copy', $funnel->id) }}" class="text-green-600 flex items-center text-xs" title="Copy Message" >
                        ...
                        <!-- DELETE (Red Button) -->
                        <button type="button" class="delete-sms-funnel-btn text-red-600 flex items-center text-xs" title="Delete"  data-id="{{ $funnel->id }}"
