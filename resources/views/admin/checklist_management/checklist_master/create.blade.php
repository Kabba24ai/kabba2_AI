    ...
    <div id="step2" class="hidden max-w-4xl mx-auto bg-white p-6 rounded-lg shadow space-y-6 mt-6">
        ...
        <form id="templateForm" class="space-y-4 grid md:grid-cols-2 gap-4">
            ...
            <label for="template_{{ $template->id }}"
                class="flex justify-between mb-0 gap-4 border border-gray-200 rounded-lg p-4 cursor-pointer transition-all">
                ...
                <div class="flex flex-col gap-2">
                    <div class="flex items-top gap-3">
                        ...
                        <div>
                            <p class="font-semibold text-gray-900 leading-tight">{{ $template->template_name }}</p>
