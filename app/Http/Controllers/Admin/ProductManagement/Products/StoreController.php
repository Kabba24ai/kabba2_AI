        ...
        try {
            ...
            if ($validated['product_type'] === 'Retail') {
                $productData = array_merge($productData, [
                    ...
                    'rental_truck_insurance_daily' => null,
                    'rental_truck_insurance_weekend' => null,
                    'rental_truck_insurance_weekly' => null,
                    'rental_truck_insurance_monthly' => null,
                ...
                $productData = array_merge($productData, [
                    ...
                    'rental_truck_insurance_daily' => $validated['rental_truck_insurance_daily'] ?? null,
                    'rental_truck_insurance_weekend' => $validated['rental_truck_insurance_weekend'] ?? null,
                    'rental_truck_insurance_weekly' => $validated['rental_truck_insurance_weekly'] ?? null,
                    'rental_truck_insurance_monthly' => $validated['rental_truck_insurance_monthly'] ?? null,
