...
<div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
    ...
    {{-- Gross Sales — all realized revenue (net sales + tax + account payments − refunds) --}}
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 shadow-sm">
        ...
        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $kpis['total_realized_revenue'] }}</p>
        <p class="text-xs text-gray-400 mt-1">All realized revenue</p>
    </div>
    ...
    {{-- Net Sales — product revenue only (order line items minus discounts) --}}
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-blue-200 dark:border-blue-700 p-4 shadow-sm ring-1 ring-blue-100 dark:ring-blue-900">
        ...
        <p class="text-xs text-gray-400 mt-1">Product revenue minus discounts</p>
    </div>
