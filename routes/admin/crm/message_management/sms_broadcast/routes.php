...
use App\Http\Controllers\Admin\Crm\MessageManagement\SmsBroadcast\ArchiveController;

// Message Library — reusable SMS content. Sending lives in the
// broadcast wizard / queue routes, never here.
Route::prefix('sms-broadcast')
    ...
    ->group(function () {
        ...
        Route::post('/{id}/archive', ArchiveController::class)->name('archive');
