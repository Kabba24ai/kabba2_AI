...
<div class=" flex flex-col md:flex-row items-start md:items-center justify-between w-full border-b border-gray-200 px-2 py-2">
...
<section class="">
    ...
    <div id="step4" class="hidden max-w-4xl mx-auto text-center py-12">
        ...
        <input type="hidden" name="equipment_ids" id="selectedEquipmentIds">
       ...
       <div class="border border-gray-200 rounded-lg max-h-[400px] overflow-y-auto bg-white p-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                @foreach($equipments ?? [] as $equipment)
                    <label class="equipment-item flex items-center justify-between gap-3 p-4 border rounded-lg transition-all
    {{ $equipment->checklist_master_id ? 'bg-gray-100 opacity-60 cursor-not-allowed' : 'hover:bg-gray-50 cursor-pointer' }}" 
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <input type="checkbox" name="equipment_ids[]" value="{{ $equipment->id }}"
                                class="w-5 h-5 text-green-600 border-gray-300 rounded"  {{ $equipment->checklist_master_id ? 'disabled' : '' }} >
