    ...
    <div class="bg-gray-50 px-4 py-4 border-b border-gray-200">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                <!-- Back to Roles -->
                <a href="{{ route('admin.roles.manage.role') }}" class="flex items-center text-gray-600 hover:text-gray-800 transition">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Edit a role with specific permissions</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        {{ html()->form()->attributes([
                            ...
                            @include('admin.roles.partials._role_form')
                        {{ html()->form()->close() }}
