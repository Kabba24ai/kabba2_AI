...
@section('content')
            ...
            <div class="flex items-center space-x-4 ">
                ...
                <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                    <button @click="selected = 'parts'"
                        ...
                        class="w-full sm:w-auto px-6 py-3 rounded-lg text-md flex items-center gap-2" type="button">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-5 lg:grid-cols-5 xl:grid-cols-5 gap-4 mb-6">
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100" data-status="">
                        <div class="flex items-center justify-between">
                            ...
                            <svg class="h-6 w-6 text-gray-600 opacity-80" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                            </svg>
                    ...
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100" data-status="in-stock">
                        <div class="flex items-center justify-between">
                            ...
                            <svg class="h-6 w-6 text-green-600 opacity-80" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                            </svg>
                    ...
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100" data-status="buy-now">
                        <div class="flex items-center justify-between">
                            ...
                            <svg class="h-6 w-6 text-yellow-600 opacity-80" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                            </svg>
                    ...
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100" data-status="out-of-stock">
                        <div class="flex items-center justify-between">
                            ...
                            <svg class="h-6 w-6 text-red-600 opacity-80" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                            </svg>
                ...
                <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100 mb-6">
                    <form class="flex flex-wrap gap-4 items-end">
                        ...
                        <div class="w-full sm:w-48">
                            ...
                            <!-- partlist Filter -->
                            <select id="partlist-filter" name="partlist"
                                class="w-full px-4 py-3 border border-gray-300 rounded-md text-sm text-gray-900">
                    ...
                    <form class="flex flex-wrap items-end justify-between gap-4">
                        ...
                        <div class="flex flex-wrap gap-4 items-end">
                            ...
                            <div class="relative w-full sm:w-48">
                                ...
                                <input type="text" name="tsearch" value="{{ request('tsearch') }}"
    ...
    <div id="supplierModal"
        ...
        <div class="modal-scrollable w-full mx-auto">
            <div
                class="bg-white rounded-lg shadow-xl w-full mx-auto max-w-7xl flex flex-col max-h-full overflow-hidden border border-gray-200">

                <div class="flex items-center justify-between p-6 border-b border-gray-200">
                    <div class="flex items-center space-x-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-building2 h-8 w-8 text-blue-600">
                ...
                <div class="flex justify-end gap-2 pt-4 pb-4 px-4 border-t border-gray-200">
                    <button type="button" onclick="closeSupplierModal()"
                        class="px-4 py-2 text-sm rounded border border-gray-300 bg-white">Close</button>
                </div>
            </div>
        </div>
    </div>

    <div id="partListModal"
        class="fixed inset-0 z-[99999] flex items-center justify-center bg-black/50 px-4 py-10 hidden">
        <div class="modal-scrollable w-full mx-auto">
            <div
                class="bg-white rounded-lg shadow-xl w-full mx-auto max-w-md flex flex-col max-h-full border border-gray-200">

                <div class="flex items-center justify-between px-6 pt-4">
                    <h2 class="text-lg font-semibold text-gray-900">Assigned Parts Lists</h2>
                    <button onclick="closePartListModal()"
                        class="text-gray-400 hover:text-gray-700 text-xl">&times;</button>
                </div>
    ...
    `;
      ...
      `;
                li.addEventListener('click', () => {
                    // highlight
                    ul.querySelectorAll('li').forEach(el => el.classList.remove('bg-blue-50', 'border-l-4',
            ...
            statusCards.forEach(card => {
                card.addEventListener('click', function() {
                    ...
                    statusCards.forEach(c => c.classList.remove(
                        'ring-2', 'ring-green-500', 'ring-yellow-500', 'ring-red-500',
                        'ring-gray-400'
                    ));
            ...
            window.deleteTemplate = function(id, name) {
                window.showConfirm(
                    ...
                    if (result.isConfirmed) {
                        let deleteUrl =
                            `{{ route('admin.maintenance-management.parts.parts-list.delete', ['list' => ':id']) }}`;
