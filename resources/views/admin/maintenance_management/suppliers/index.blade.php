...
@section('content')
    ...
    <div class="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100 mb-6">
        ...
        <form method="GET" action="{{ route('admin.maintenance-management.suppliers.index') }}"
            class="flex flex-wrap gap-4 items-end">
            <div class="w-full sm:w-auto">
                <label class="block text-sm font-medium text-gray-700 mb-1">Clear Filters</label>
            ...
            <div class="w-full sm:w-48">
                ...
                <select id="supplierpartCategory" name="category"
                    class="w-full px-3 py-3 border border-gray-300 rounded-md text-sm text-gray-900 focus:border-brand-500 focus:ring-1 focus:ring-brand-500">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById('clear-filters').addEventListener('click', function() {
                ...
                window.fetchSuppliers(1, perPage); // Refresh table after clearing filters
            });
            ...
            window.deleteSupplier = function(id, name) {
                window.showConfirm(
                    ...
                    if (result.isConfirmed) {
                        let deleteUrl =
                            `{{ route('admin.maintenance-management.suppliers.delete', ['supplier' => ':id']) }}`;
