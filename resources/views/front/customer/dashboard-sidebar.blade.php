<div class="dash-sidebar">
    ...
    <ul class="mt-5 dashboard-nav">
        <li class="{{ Route::is('front.customer.dashboard.index') ? 'active' : '' }} px-4 py-3 border-b-0 last:border-b hover:bg-yellow-400 hover:text-white hover:border hover:border-yellow-400">
        ...
        <li class=" px-4 py-3 border-b-0 last:border-b hover:bg-yellow-400 hover:text-white hover:border hover:border-yellow-400 ">
            <a href="javascript:void(0)" class="w-full flex gap-x-2"> <i class="fa-solid fa-user text-xl min-w-6 max-w-6"></i> Profile</a>
        </li>
        <li class=" px-4 py-3 border-b-0 last:border-b hover:bg-yellow-400 hover:text-white hover:border hover:border-yellow-400 ">
            <a href="javascript:void(0)" class="w-full flex gap-x-2"><i class="fa-solid fa-shopping-cart text-xl min-w-6 max-w-6"></i> Orders</a>
        </li>
        <li class="  px-4 py-3 border-b-0 last:border-b hover:bg-yellow-400 hover:text-white hover:border hover:border-yellow-400 ">
        ...
        <li class="px-4 py-3 border-b-0 hover:bg-yellow-400 hover:text-white hover:border hover:border-yellow-400">
