        ...
        <div class="mx-auto px-4 lg:px-8 lg:flex lg:items-center flex flex-wrap gap-8 justify-between">
            <div class="lg:flex gap-4 w-5/5 md:w-2/5 lg:w-1/5 items-center">
                <div class=" mt-4 lg:mt-0 leading-[1.6]">
                    ...
                    <a href="javascript:void(0)"
                        class="hover:text-yellow-400 text-sm mb-1 text-neutral-200/60 transition-all duration-300 ease-in-out flex gap-2">Equipment
                        Rentals</a>
            ...
            <div class="w-5/5 md:w-1/5 lg:w-1/5 md:mt-0">
                ...
                <a href="{{ route('front.contact-us.index') }}"
                    class="hover:text-yellow-400 text-sm mb-1 text-neutral-200/60 transition-all duration-300 ease-in-out flex gap-2">Contact
                    Us</a>
                <a href="{{ route('front.terms-and-conditions.general') }}"
                    class="hover:text-yellow-400 text-sm mb-1 text-neutral-200/60 transition-all duration-300 ease-in-out flex gap-2">Terms
                    & Conditions</a>
                <a href="{{ route('front.privacy-policy.index') }}"
                    class="hover:text-yellow-400 text-sm mb-1 text-neutral-200/60 transition-all duration-300 ease-in-out flex gap-2">Privacy
                    Policy</a>
                <a href="{{ config('app.domains.opportunities') }}" target="_blank"
                    class="hover:text-yellow-400 text-sm mb-1 text-neutral-200/60 transition-all duration-300 ease-in-out flex gap-2">Employment
                    Opportunities</a>
