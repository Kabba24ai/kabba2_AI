    ...
    <div class="bg-gray-50 px-4 py-4 border-b border-gray-200">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                <!-- Back to Employees -->
                <a href="{{route('admin.roles.index')}}" class="flex items-center text-gray-600 hover:text-gray-800 transition">
            ...
            <div class="flex flex-wrap gap-2">
                <div class="inline">
                    <a href="{{ route('admin.roles.edit.user',$user->unique_id ) }}" class="inline-flex items-center justify-center rounded-lg bg-brand-500 px-4 py-2 text-sm font-medium text-white shadow hover:bg-brand-600 focus:outline-none focus:ring-2 focus:ring-brand-400 dark:focus:ring-brand-500">
                        Edit Employee
                    </a>
                </div>
            </div>
        ...
        <div class="flex-1">
            ...
            <div class="mt-3 flex flex-wrap gap-2">
                ...
                @endif
                  ...
                  @elseif($user->pay_type === 'Hourly')
                        <span class="px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">hourly</span>
                  @endif
