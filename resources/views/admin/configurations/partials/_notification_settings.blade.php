            ...
            <div class="space-y-3 bg-blue-50 p-4 rounded-xl border border-blue-200">
                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="flex flex-col gap-2 sm:flex-row sm:justify-end">
                        <button type="button" data-add-hrm="order"
                            class=" flex items-center gap-2 px-6 py-3 bg-blue-600 text-md text-white font-medium rounded-lg">
                            <svg aria-hidden="true" class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <button type="button" data-edit="order"
                ...
                <div id="view-table-order" class="space-y-4">
                    @include('admin.configurations.partials._notification_view_table', [
                        'rows' => $newOrderRows,
                    ])
...
<div id="manual-modal" class="fixed inset-0 z-[99999] hidden items-center justify-center bg-black/50 px-4 py-10">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6 space-y-4">
        ...
        <div>
            ...
            <input id="manual-phone" type="text"
        ...
        <div class="flex justify-end gap-2 pt-3">
            <button type="button" id="cancel-manual" class="px-6 py-3 border rounded-lg">
                Cancel
            </button>

            <button type="button" id="save-manual" class="px-6 py-3 bg-blue-600 text-white rounded-lg">
                Save
            </button>
        </div>
    </div>
