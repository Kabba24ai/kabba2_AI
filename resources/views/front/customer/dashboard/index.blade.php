    ...
    <div class="rounded-xl dark:border-gray-800" x-data="{ activeTab: '{{ session('active_tab', 'dashboard') }}' }">
        <div class="container">
            ...
            <div class="border-b border-gray-200">
                <nav
                    class="flex space-x-2 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-600 dark:scrollbar-track-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar]:h-1.5">
    ...
    function initializeEditUI() {
        ...
        if (editBtn && cancelBtn && saveBtn) {
            ...
            cancelBtn.onclick = () => {
                ...
                // console.log("Cancel clicked — resetting Parsley");

                //  First clear Parsley errors
                document.querySelectorAll("form").forEach(form => {
                    const parsleyInstance = $(form).data('Parsley') || $(form).parsley();
                    if (parsleyInstance) {
