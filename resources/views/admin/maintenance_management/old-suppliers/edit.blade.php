...
<div class="min-h-screen bg-gray-50">
        ...
        <div class="px-6 py-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Update supplier information and settings</p>
                </div>
            </div>
        </div>
    </div>
    ...
    {{-- Form --}}
    <div class="px-6 py-6">
        <form method="POST" action="{{ route('admin.maintenance-management.suppliers.edit', $supplier->unique_id) }}" class="max-w-6xl mx-auto">
            @csrf
            @method('PUT')
